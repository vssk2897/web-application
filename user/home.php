    ...
    <div class="" id="accordion">
        ...
        <div class="card ">
            ...
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="card-block">
                    <?php include("./query_scripts/c&g.php"); ?> 
                </div>
            </div>
        </div>
        <div class="card ">
            ...
            <div id="collapseTen" class="panel-collapse collapse">
                <div class="card-block">
                    <?php include("./query_scripts/6.php"); ?> 
                </div>
            </div>
        </div>
        <div class="card ">
        ...
        <div class="card ">
            ...
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="card-block">
                    <?php include("./query_scripts/1.php"); ?>
                </div>
            </div>
        </div>
        <div class="card ">
            ...
            <div id="collapseThree" class="panel-collapse collapse">
                <div class="card-block">
                    <?php include("./query_scripts/2.php"); ?>
                </div>
            </div>
        </div>
        <div class="card ">
            ...
            <div id="collapseFive" class="panel-collapse collapse">
                <div class="card-block">
                    <?php include("./query_scripts/3.php")?><br />
                </div>
            </div>
        </div>
        <div class="card ">
            ...
            <div id="collapseSix" class="panel-collapse collapse">
                <div class="card-block">
                    ...
                    <?php include("./query_scripts/4.php")?>
                </div>
            </div>
        </div>
        <div class="card ">
            ...
            <div id="collapseEight" class="panel-collapse collapse">
                <div class="card-block">
                    <?php include("./query_scripts/5.php")?>
                </div>
            </div>
        </div>
